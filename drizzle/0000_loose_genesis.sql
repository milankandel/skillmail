...
CREATE TABLE "skills" (
	...
	"match_from" text,
	"match_subject" text,
	"draft_reply" boolean DEFAULT false NOT NULL,
...
ALTER TABLE "extractions" ADD CONSTRAINT "extractions_skill_id_skills_id_fk" FOREIGN KEY ("skill_id") REFERENCES "public"."skills"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "extractions_message_skill_key" ON "extractions" USING btree ("message_id","skill_id");--> statement-breakpoint
